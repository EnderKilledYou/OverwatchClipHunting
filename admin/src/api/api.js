...
static list_twitch_clips (page,) {

    return Core.makeRequest("/api/clips/list_twitch_clips", {
        page: page,
        });
}
...
static list_streamers () {

    return Core.makeRequest("/api/streamer/list_streamers", {
        });
}
